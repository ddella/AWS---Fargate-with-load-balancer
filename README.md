...
![Container URI](images/Picture7.png)
2. Add the **Inbound rules**. Leave the default **Onbound rules**.
![Container URI](images/Picture8.png)
...
![Cluster template](images/Picture35.png)
